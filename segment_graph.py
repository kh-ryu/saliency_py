...
def diff(blue_band, green_band, red_band, NIR_band, red_edge_band, x1, y1, x2, y2):
    result = math.sqrt(
        square(blue_band[y1, x1] - blue_band[y2, x2]) + square(green_band[y1, x1] - green_band[y2, x2]) + square(
            red_band[y1, x1] - red_band[y2, x2]) + square(NIR_band[y1, x1] - NIR_band[y2, x2]) + square(red_edge_band[y1, x1] - red_edge_band[y2, x2]))
    return result
